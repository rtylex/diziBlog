<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.Master" AutoEventWireup="true" CodeBehind="BlogDetay.aspx.cs" Inherits="diziProjesi.BlogDetay" %>
            ...
            <div class="container">
                <div class="col-md-8 single-main">
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Kullanıcı Adınız:" requierd=""></asp:TextBox>

                            <asp:TextBox ID="TextBox2" runat="server" placeholder="Mail Adresiniz:"></asp:TextBox>
                            <asp:TextBox ID="TextBox3" runat="server" placeholder="Yorumunuz:" TextMode="MultiLine" Height="75"></asp:TextBox>
